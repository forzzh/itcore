	...
	$.extend(Plugin.prototype, {
		...
		tooltip: function() {
			if (!this.tipso_bubble) {
				this.tipso_bubble = $(
					'<div class="tipso_bubble"><div class="tipso_title clearfix"></div><div class="tipso_content"></div><div class="tipso_arrow"></div></div>'
				);
			}
		...
		show: function() {
			...
			if (obj.mode === 'hide') {
				...
				tipso_bubble.find('.tipso_content').html( /*obj.content()*/ '<span>' + obj.content() + '</span><a href="javascript:;" onclick="' + obj.settings.url + '">' + obj.settings.test + '</a>');
				console.log('dadaf ' + obj.settings.url);
