...
<form id="myform">
 <table class="table table-bordered">
         <tr>
         	<td  width="10%" align="right" bgcolor="#f1f1f1">话题id:</td>
         	<td  width="28%"><input type="text" name="topicId" id="lname" id="input18" class="span1-1" /> </td>
         	<td  width="10%" align="right" bgcolor="#f1f1f1">次序:</td>
         	<td  width="28%"><input type="text" name="range"  id="input18"  class="span1-1" /> </td>
         	<td  width="10%" align="right" bgcolor="#f1f1f1">说明:</td>
         	<td  width="28%"><input type="text" name="description"  id="input18"  class="span1-1" /> </td>
         </tr>
 </table>
 <div style="margin-left:75%;">
		  <input type="button" value="提交" onclick="setTopicRange()"/>
...
<script type="text/javascript">
function setTopicRange(){
var params = $("#myform").serialize();

 $.ajax({url : "/manager/indexTopic/setTopicRange",
         type : "get",
