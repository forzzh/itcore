...
<form id="myform">
 <table class="table table-bordered">
         <tr>
            <td  width="10%" align="right" bgcolor="#f1f1f1">新标签名称:</td>
         	<td  width="23%"><input type="text" name="newName" id="input18"  class="span1-1" /> </td>
         	<td  width="10%" align="right" bgcolor="#f1f1f1">原标签名称:</td>
         	<td  width="23%"><input type="text" name="name" id="lname" id="input18" class="span1-1" /> </td>
         </tr>
 </table>
...
var params = $("#myform").serialize();
 $.ajax({url : "/manager/label/setLabelName",
         type : "get",
